...
export default function ChatbotWidget({ isOpen, bottomOffset = 24 }) {
  ...
  return (
    <div
      className="fixed right-4 sm:right-6 z-40 w-[calc(100vw-2rem)] max-w-sm h-[28rem] bg-[#FFFDF9] border border-[#B8945A]/40 shadow-2xl flex flex-col animate-in fade-in slide-in-from-bottom-4 duration-300"
      style={{ bottom: `${bottomOffset + 240}px` }}
    >
      {/* Header */}
      <div className="p-4 bg-[#1E1C1A] text-[#FFFDF9] flex items-center justify-between flex-shrink-0">
